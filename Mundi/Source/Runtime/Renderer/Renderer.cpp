...
// ============================================================================
// Primitive Batch Rendering System (반투명 Physics Body/Weight 시각화용)
// ============================================================================

void URenderer::InitializePrimitiveBatch()
{
	// Create ULineDynamicMesh for solid primitive batching (same structure as line mesh)
	DynamicPrimitiveMesh = UResourceManager::GetInstance().Load<ULineDynamicMesh>("Primitive");
	DynamicPrimitiveMesh->Load(MAX_PRIMITIVE_VERTICES, MAX_PRIMITIVE_INDICES, RHIDevice->GetDevice());
